    ...
    >
      ...
      <div className="hidden lg:flex items-center gap-3">
        ...
        <div>
          ...
          <p className="font-body text-ink-hint text-[10px]">AI-powered pattern generator</p>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="flex flex-col gap-3">
            ...
            {/* Opt-in crop refine — auto-fit has already made the image
                pipeline-ready, but power users can override the default
                centre-letterbox framing if they want to zoom in on a
                specific part of the subject. 90% of uploads can skip it. */}
            {rawImage && image && (
              <button
                type="button"
            ...
            {/* AI styled preview — appears after first Generate. Side-by-side
                with the source above so the user can see what Gemini did.
                Hidden until we have a result so it doesn't feel empty. */}
            {stylizedPreview && (
        ...
        {/* Generate Button — primary CTA for the panel, cotton fill but
            quieter than v2 sticker (2px shadow instead of 3px, no shouting). */}
        <button
        ...
        {/* Clear AI result — only visible when a cached Gemini result exists.
            Lets the user force a re-call next Generate (e.g. if the AI
            output wasn't great). Quiet styling so it doesn't fight the CTA. */}
        {cachedStylizedImage && !isGenerating && (
          <button
